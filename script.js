...
// Global data containers (declare before initial rendering to avoid TDZ errors)
let hotelsData = [];
...
// (globals `hotelsData`, `compareSelection`, `countriesJsonData` and `localGuidesData` are declared above)

// Get country from URL
const params = new URLSearchParams(window.location.search);
const countryName = params.get("country");
const hotelParam = params.get("hotel");
// (globals `hotelsData`, `compareSelection`, `countriesJsonData` and `localGuidesData` are declared earlier)
